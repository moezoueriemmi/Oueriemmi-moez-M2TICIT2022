...
class DetailWidget extends StatefulWidget {
  ...
  DetailWidget({required this.article});
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            /// 20.0
            FoodName(article: widget.article),
            // FoodDescription(),
            Container(
                child: Column(
            ...
            FeaturesFood(),
            IncreaseDecrease(article: widget.article),
            AddToCartButton(
                article: widget.article, remarque: ingredientsClient),
          ],
        ),
      ),
    );
