...
import '../../configuration/articleSandwich_list.dart';

class Sandwichs extends StatefulWidget {
  const Sandwichs({Key? key}) : super(key: key);

  @override
  _SandwichsState createState() => _SandwichsState();
}
...
class _SandwichsState extends State<Sandwichs> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<Article>>(
      future: bringTheArticlesSandwich(),
