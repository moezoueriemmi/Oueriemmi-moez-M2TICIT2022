...
import 'package:food_order_ui/configuration/articleCrepe_list.dart';
...
class Crepes extends StatefulWidget {
  const Crepes({Key? key}) : super(key: key);

  @override
  _CrepesState createState() => _CrepesState();
}

class _CrepesState extends State<Crepes> {
  @override
  Widget build(BuildContext context) {
    return FutureBuilder<List<Article>>(
      future: bringTheArticlesCrepe(),
