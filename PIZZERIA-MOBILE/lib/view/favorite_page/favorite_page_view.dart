...
import '../../configuration/articleBoisson_list.dart';
    ...
    return Scaffold(
      ...
      body: Padding(
        padding: EdgeInsets.symmetric(
            horizontal: SizeConfig.screenWidth! / 10.0,
            vertical: SizeConfig.screenHeight! / 130.6),

        /// 20.0 - 5.0
        child: FutureBuilder<List<Article>>(
            future: bringTheArticlesBoisson(),
                        ...
                        children: [
                          Container(
                              ...
                              child: Stack(
                                children: [
                                  FavoriteDetail(
                                      food_image_name: food.image,
                                      food_name: food.nom,
                                      food_category: food.categorie,
                                      food_price: food.prix),
                                  //FavoriteCartIcon(),
                                  // FavoriteIcon(),
                                ],
                              )),
